...
#if !defined( _LIBVSAPM_EXTERN_H )
#define _LIBVSAPM_EXTERN_H

/* To export functions from the libvsapm DLL define LIBVSAPM_DLL_EXPORT
 * To import functions from the libvsapm DLL define LIBVSAPM_DLL_IMPORT
