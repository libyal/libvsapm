 ...
 */
PyObject *pyvsapm_integer_signed_new_from_64bit(
           int64_t value_64bit )
{
	PyObject *integer_object = NULL;
	static char *function    = "pyvsapm_integer_signed_new_from_64bit";
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyvsapm_integer_unsigned_new_from_64bit(
           uint64_t value_64bit )
{
	PyObject *integer_object = NULL;
	static char *function    = "pyvsapm_integer_unsigned_new_from_64bit";
 ...
 */
int pyvsapm_integer_signed_copy_to_64bit(
     PyObject *integer_object,
     int64_t *value_64bit,
     libcerror_error_t **error )
{
	static char *function   = "pyvsapm_integer_signed_copy_to_64bit";
	int result              = 0;
 ...
 * Returns 1 if successful or -1 on error
 */
int pyvsapm_integer_unsigned_copy_to_64bit(
     PyObject *integer_object,
     uint64_t *value_64bit,
     libcerror_error_t **error )
{
	static char *function   = "pyvsapm_integer_unsigned_copy_to_64bit";
	int result              = 0;
