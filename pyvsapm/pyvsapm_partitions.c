...
PySequenceMethods pyvsapm_partitions_sequence_methods = {
	/* sq_length */
	(lenfunc) pyvsapm_partitions_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyvsapm_partitions_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyvsapm_partitions_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyvsapm.partitions",
	/* tp_basicsize */
	sizeof( pyvsapm_partitions_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyvsapm_partitions_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyvsapm_partitions_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyvsapm sequence and iterator object of partitions",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyvsapm_partitions_iter,
	/* tp_iternext */
	(iternextfunc) pyvsapm_partitions_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyvsapm_partitions_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyvsapm_partitions_new(
           ...
           int number_of_items )
{
	pyvsapm_partitions_t *sequence_object = NULL;
	static char *function                 = "pyvsapm_partitions_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyvsapm_partitions_type_object );
...
/* Initializes a partitions sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyvsapm_partitions_init(
     pyvsapm_partitions_t *sequence_object )
{
	static char *function = "pyvsapm_partitions_init";
      ...
      pyvsapm_partitions_t *sequence_object )
{
	...
	static char *function       = "pyvsapm_partitions_free";
...
Py_ssize_t pyvsapm_partitions_len(
            pyvsapm_partitions_t *sequence_object )
{
	static char *function = "pyvsapm_partitions_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function      = "pyvsapm_partitions_getitem";
...
PyObject *pyvsapm_partitions_iter(
           pyvsapm_partitions_t *sequence_object )
{
	static char *function = "pyvsapm_partitions_iter";
...
{
	PyObject *partition_object = NULL;
	static char *function      = "pyvsapm_partitions_iternext";
