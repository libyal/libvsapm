...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$ResultRun = RunTestBinary ${TestExecutablesDirectory} "vsapm_test_${TestName}"
...
$TestInputs = GenerateTestInputs "libvsapm" ${OptionSets}
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$ResultRun = RunTestBinaryWithInput ${TestExecutablesDirectory} "vsapm_test_${TestName}" ${TestInput}
