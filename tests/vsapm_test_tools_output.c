...
#include "../vsapmtools/vsapmtools_output.h"

/* Tests the vsapmtools_output_initialize function
 * Returns 1 if successful or 0 if not
 */
int vsapm_test_tools_output_initialize(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;

	result = vsapmtools_output_initialize(
	          _IONBF,
	          &error );
...
#endif
{
	...
	VSAPM_TEST_RUN(
	 ...
	 vsapm_test_tools_output_initialize )

	/* TODO add tests for vsapmtools_output_copyright_fprint */

	/* TODO add tests for vsapmtools_output_version_fprint */

	/* TODO add tests for vsapmtools_output_version_detailed_fprint */
