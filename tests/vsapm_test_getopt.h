...
#if !defined( _VSAPM_TEST_GETOPT_H )
#define _VSAPM_TEST_GETOPT_H
...
#define vsapm_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsapm_test_getopt(
                  int argument_count,
...
#endif /* !defined( _VSAPM_TEST_GETOPT_H ) */
