...
#include "vsapmtools_i18n.h"
#include "vsapmtools_libbfio.h"
#include "vsapmtools_libcerror.h"
#include "vsapmtools_libuna.h"
...
{
	static char *function = "vsapmtools_output_initialize";
      ...
      FILE *stream )
{
	...
	fprintf(
	 stream,
	 "Copyright (C) 2009-2023, Joachim Metz <%s>.\n"
