...
void (*vsapmtools_signal_signal_handler)( vsapmtools_signal_t ) = NULL;
             ...
             vsapmtools_signal_t signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( vsapmtools_signal_signal_handler != NULL )
			{
				vsapmtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void vsapmtools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int vsapmtools_signal_attach(
     void (*signal_handler)( vsapmtools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "vsapmtools_signal_attach";
...
#if defined( _MSC_VER )
	vsapmtools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	vsapmtools_signal_signal_handler = NULL;
