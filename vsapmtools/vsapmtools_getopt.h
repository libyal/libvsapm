...
#if !defined( _VSAPMTOOLS_GETOPT_H )
#define _VSAPMTOOLS_GETOPT_H
...
typedef struct vsapmtools_option vsapmtools_option_t;

struct vsapmtools_option
{
...
#define vsapmtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsapmtools_getopt(
                  int argument_count,
...
void vsapmtools_getopt_wrapped_fprint(
      FILE *stream,
...
void vsapmtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vsapmtools_option_t *options,
      int number_of_options );

int vsapmtools_getopt_get_options_string(
     const vsapmtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _VSAPMTOOLS_GETOPT_H ) */
