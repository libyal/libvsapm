...
#include "libvsapm_libclocale.h"
#include "libvsapm_support.h"
...
const char *libvsapm_get_version(
             void )
{
	return( (const char *) LIBVSAPM_VERSION_STRING );
}
...
int libvsapm_get_access_flags_read(
     void )
{
	return( (int) LIBVSAPM_ACCESS_FLAG_READ );
}
...
int libvsapm_get_access_flags_read_write(
     void )
{
	return( (int) ( LIBVSAPM_ACCESS_FLAG_READ | LIBVSAPM_ACCESS_FLAG_WRITE ) );
}
...
int libvsapm_get_access_flags_write(
     void )
{
	return( (int) LIBVSAPM_ACCESS_FLAG_WRITE );
}
...
{
	static char *function = "libvsapm_get_codepage";
...
int libvsapm_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsapm_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libvsapm_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libvsapm_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
