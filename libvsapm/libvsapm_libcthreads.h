...
#if !defined( _LIBVSAPM_LIBCTHREADS_H )
#define _LIBVSAPM_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBVSAPM )
#define HAVE_LIBVSAPM_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBVSAPM_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBVSAPM_LIBCTHREADS_H ) */
