...
{
	static char *function = "libvsapm_notify_set_stream";
...
int libvsapm_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsapm_notify_stream_open";
...
int libvsapm_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvsapm_notify_stream_close";
